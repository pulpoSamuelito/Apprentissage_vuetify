                  ...
                  <v-row>
                    <v-col cols="12" md="8">
                      <v-card-text class="mt-12">
                        <h1 class="text-center display-2 teal--text text--accent-3"> Sign in to Reporting </h1>
                    ...
                    <v-col cols="12" md="4" class="teal accent-3">
                      <v-card-text class="while--text mt-12">
                  ...
                  <v-row class="fill-height">
                    <v-col cols="12" md="4" class="teal accent-3">
                      <v-card-text class="while--text mt-12">
                        ...
                        <h5 class="text-center"> To keep connected with us please login with your personanel info</h5>
                      </v-card-text>
                      <div class="text-center">
                        <v-btn rounded outlined="" dark @click="step++"> SIGN IN </v-btn>
                      </div>
